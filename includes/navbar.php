            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto py-4 py-lg-0">
                    ...
                    <?php if (isset($_SESSION['username'])) : ?>
                        ...
                        <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="http://localhost/Clean-Blog/posts/create.php">create</a>
                        </li>
                    ...
                    <?php else : ?>
                        <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="http://localhost/Clean-Blog/auth/login.php">login</a>
                        </li>
                        <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="http://localhost/Clean-Blog/auth/register.php">register</a></li>

                    <?php endif; ?>

                    <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="http://localhost/Clean-Blog/contact.php">Contact</a>
                    </li>
                </ul>
            </div>
        </div>
